...
* [Research Guide on Newspapers](https://guides.library.utoronto.ca/newspapers)

### Books

* [100 Site Analysis Essentials: An Architect’s Guide](https://librarysearch.library.utoronto.ca/permalink/01UTORONTO_INST/14bjeso/alma991107360351206196)
* [Fieldwork: Landscape Architecture Europe](https://librarysearch.library.utoronto.ca/permalink/01UTORONTO_INST/14bjeso/alma991106006724506196)
* [Interpreting Site: Studies in Perception, Representation, and Design](https://librarysearch.library.utoronto.ca/permalink/01UTORONTO_INST/14bjeso/alma991106204145706196)
* [Site Matters: Strategies for Uncertainty through Planning and Design](https://librarysearch.library.utoronto.ca/permalink/01UTORONTO_INST/14bjeso/alma991106987741806196)
* [Site Planning: International Practice](https://librarysearch.library.utoronto.ca/permalink/01UTORONTO_INST/14bjeso/alma991106660923806196)
...
* [The Toronto Carrying Place : rediscovering Toronto's most ancient trail](https://librarysearch.library.utoronto.ca/permalink/01UTORONTO_INST/14bjeso/alma991106367225906196)
* [Toronto During the French Regime : A History of the Toronto Region From Brule to Simcoe, 1615\-1793](https://librarysearch.library.utoronto.ca/permalink/01UTORONTO_INST/14bjeso/alma991107061948906196)
* [Walking into wilderness : the Toronto Carrying Place and Nine Mile Portage](https://librarysearch.library.utoronto.ca/permalink/01UTORONTO_INST/14bjeso/alma991106123191606196)
* [Atlas of Great Lakes Indian history](https://librarysearch.library.utoronto.ca/permalink/01UTORONTO_INST/14bjeso/alma991106303482206196)
* [Where Histories Meet: Indigenous and Settler Encounters in the Toronto Area](https://librarysearch.library.utoronto.ca/permalink/01UTORONTO_INST/k9bh95/alma991107591995906196)
* [Indigenous Peoples Atlas of Canada](https://librarysearch.library.utoronto.ca/permalink/01UTORONTO_INST/k9bh95/alma991106177734506196) (4 vols.)

### Planning Documents and Toronto Buildings

* [Archives of Ontario](https://www.archives.gov.on.ca/en/index.aspx )
* [City of Toronto Archives](https://www.toronto.ca/city-government/accountability-operations-customer-service/access-city-information-or-records/city-of-toronto-archives/whats-in-the-archives/  )
* Local government, e.g., [Toronto Official Plan](https://www.toronto.ca/city-government/planning-development/official-plan-guidelines/official-plan/ )
* [Toronto Building Database](https://www.acotoronto.ca/tobuilt.php )
* [Urban Toronto](https://urbantoronto.ca/)
...
* These are the official topographic maps of Canada
* Historical sheets:
...
* Modern sheets
	...
	+ Click on "Themes", then "Raster", pick a Scale, then zoom in on the map and click a tile
...
* [David Rumsey](https://www.davidrumsey.com/) (note the ability to search for text on maps, e.g., specific placenames)
...
* [City Directory guide](https://www.torontopubliclibrary.ca/history-genealogy/lh-city-directories.jsp)
* [Listing of Toronto City Directories](https://www.torontopubliclibrary.ca/history-genealogy/lh-digital-city-directories.jsp)
* [Additional information on using City Directories](https://www.toronto.ca/city-government/accountability-operations-customer-service/access-city-information-or-records/city-of-toronto-archives/whats-in-the-archives/city-directories/)
...
* Many digitized materials (books, maps, historical documents) can be found in [Canadiana](https://www.canadiana.ca/)
* [Archives of Ontario general search](https://www.archives.gov.on.ca/en/access/our_collection.aspx) and [Archives of Ontario Image Search](https://aims.archives.gov.on.ca/scripts/mwimain.dll?logon&application=UNION_VIEW&language=144&file=[AO_ASSETS]html~5chome.html) (photographs, maps)
...
* [Waterbodies](https://trca-camaps.opendata.arcgis.com/maps/162daaab43b744e5b80a2d77b882df8a )
...
* [Toronto Centreline](https://open.toronto.ca/dataset/toronto-centreline-tcl/) (also includes rivers and other line features)
* [Toronto Topographic Mapping Edge of Road](https://open.toronto.ca/dataset/topographic-mapping-edge-of-road/ )

### Demographic

* [Toronto Neighbourhood Profiles](https://open.toronto.ca/dataset/neighbourhood-profiles/)
* If using ArcGIS Online or ArcGIS Pro, the Geoenrichment functionality can be used to retrieve demographic statistics for a given geometry:
	+ [ArcGIS Online Enrich Layer](https://doc.arcgis.com/en/arcgis-online/analyze/enrich-layer-mv.htm)
	+ [ArcGIS Pro Enrich tool](https://pro.arcgis.com/en/pro-app/latest/tool-reference/analysis/enrich.htm)

### Climate

* [Historical Climate Data](https://climate.weather.gc.ca/), including historical data and monthly climate summaries back to 1840 for some parts of Canada; Historical Radar Data for some years as well

### Historical and Cultural

* [Heritage Register](https://open.toronto.ca/dataset/heritage-register/ )
...
* Note that slope, aspect, hillshade, and contours can be derived from this if needed
* [Greater Toronto Area 2002 Digital Elevation Model](https://geohub.lio.gov.on.ca/maps/b1ec60624b2f4f67bb9c4fb536e6b2fd/explore)
* [Provincial Digital Elevation Model 2019](https://geohub.lio.gov.on.ca/maps/882a9059ec7c4881abbdb6afa0ae73e6/explore)
* [Toronto Building Outlines](https://open.toronto.ca/dataset/topographic-mapping-building-outlines/)
* [Toronto 3D Massing](https://open.toronto.ca/dataset/3d-massing/) (includes building heights)
